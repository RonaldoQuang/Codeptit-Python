...
Để cho phù hợp với tình hình thời sự và giảm bớt căng thẳng cho các bạn thí sinh, ban tổ chức quyết định thêm một bài toán đơn giản: cho một dãy các số nguyên đếm tăng dần. 
Hỏi có số nào bị “đánh rơi” khi đếm hay không? 
Giả sử một dãy đếm chính xác thì luôn luôn đếm bắt đầu từ 1.
Dữ liệu vào:
